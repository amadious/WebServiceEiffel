...
public class ConvertisseurServiceLocator extends org.apache.axis.client.Service implements currencyService.ConvertisseurService {
    ...
    public currencyService.Convertisseur getConvertisseur(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            currencyService.ConvertisseurSoapBindingStub _stub = new currencyService.ConvertisseurSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (currencyService.Convertisseur.class.isAssignableFrom(serviceEndpointInterface)) {
                currencyService.ConvertisseurSoapBindingStub _stub = new currencyService.ConvertisseurSoapBindingStub(new java.net.URL(Convertisseur_address), this);
                _stub.setPortName(getConvertisseurWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://currencyService", "ConvertisseurService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://currencyService", "Convertisseur"));
        }
